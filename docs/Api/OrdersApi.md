# EzzeSiftuz\OrdersV4\OrdersApi

All URIs are relative to *https://live.api.otto.market*

Method | HTTP request | Description
------------- | ------------- | -------------
[**cancelPartnerOrders**](OrdersApi.md#cancelpartnerorders) | **POST** /v4/orders/{salesOrderId}/cancellation | Cancel all position items of an order
[**findPartnerOrders**](OrdersApi.md#findpartnerorders) | **GET** /v4/orders | List of orders filtered by fulfillment state
[**getPartnerOrderByOrderNumber**](OrdersApi.md#getpartnerorderbyordernumber) | **GET** /v4/orders/{orderNumber} | Get an order via order number
[**getPartnerOrderBySalesOrderId**](OrdersApi.md#getpartnerorderbysalesorderid) | **GET** /v4/orders/{salesOrderId} | Get an order via sales order id
...
$apiInstance = new EzzeSiftuz\OrdersV4\Api\OrdersApi(
